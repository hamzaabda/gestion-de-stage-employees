    ...
    <div className="dashboard-container">
      <div className="sidebar">
        <div className="sidebar_menu">
          ...
          <a href="/stage" className="custom-link">
            <FontAwesomeIcon icon={faUsers} className="me-3" /><b>stage</b>
          </a>
          <a href="/job" className="custom-link">
            <FontAwesomeIcon icon={faPhotoFilm} className="me-3" /><b>job</b>
          </a>
          <a href="/register" className="custom-link">
            <FontAwesomeIcon icon={faPhotoFilm} className="me-3" /><b>Création compte admin</b>
          </a>
